...
export default function SfxMakeupArtistsPage() {
  return (
    <main style={styles.page}>
      <section style={styles.hero}>
        ...
        <div style={styles.heroContent}>
          ...
          <h1 style={styles.title}>SFX Makeup Artists</h1>

          <p style={styles.subtitle}>
            Explore artists creating character transformations, prosthetics,
            fantasy effects, and cinematic visual storytelling.
          </p>
        </div>
      </section>
      ...
      <section style={styles.section}>
        ...
        <div style={styles.filters}>
          ...
          <select style={styles.select} defaultValue="">
            ...
            <option value="Creature Design">Creature Design</option>
            <option value="Character Transformation">Character Transformation</option>
            <option value="Fantasy Effects">Fantasy Effects</option>
      ...
      <section style={styles.section}>
        ...
        <h2 style={styles.sectionTitle}>Featured SFX Makeup Artists</h2>

        <p style={styles.sectionText}>
          Hand-selected SFX makeup artists will appear here as the Collective
          grows.
        </p>
        ...
        <div style={styles.featuredGrid}>
          <div style={styles.featuredCard}>
            ...
            <div style={styles.cardBody}>
              <p style={styles.cardLabel}>Featured SFX Makeup Artist</p>
      ...
      <section style={styles.section}>
        ...
        <h2 style={styles.sectionTitle}>All SFX Makeup Artists</h2>

        <p style={styles.sectionText}>
          Verified SFX makeup artist listings will populate this section once
          approved profiles are added.
        </p>
        ...
        <div style={styles.directoryGrid}>
          <div style={styles.directoryCard}>
            ...
            <div style={styles.cardBody}>
              <h3 style={styles.directoryTitle}>SFX Artist Listing</h3>
      ...
      <section style={styles.ctaSection}>
        ...
        <p style={styles.sectionText}>
          SFX makeup artists may submit for review. Hand-selected professionals
          may also be added directly by Aset.
        </p>
