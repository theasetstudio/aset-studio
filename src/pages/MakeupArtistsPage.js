    ...
    <main style={styles.page}>
      <section style={styles.hero}>
        ...
        <div style={styles.heroContent}>
          ...
          <h1 style={styles.title}>Makeup Artists</h1>

          <p style={styles.subtitle}>
            Discover verified makeup professionals shaping beauty, presentation,
            and transformation across entertainment, media, and creative
            productions.
          </p>
        </div>
      </section>
      ...
      <section style={styles.section}>
        ...
        <div style={styles.filters}>
          ...
          <select style={styles.select} defaultValue="">
            ...
            <option value="Creative / Fantasy">Creative / Fantasy</option>
          </select>
        </div>
      </section>
      ...
      <section style={styles.section}>
        ...
        <h2 style={styles.sectionTitle}>Featured Makeup Artists</h2>

        <p style={styles.sectionText}>
          Hand-selected makeup artists will appear here as the Collective grows.
        </p>
        ...
        <div style={styles.featuredGrid}>
          <div style={styles.featuredCard}>
            ...
            <div style={styles.cardBody}>
              <p style={styles.cardLabel}>Featured Makeup Artist</p>
      ...
      <section style={styles.section}>
        ...
        <h2 style={styles.sectionTitle}>All Makeup Artists</h2>

        <p style={styles.sectionText}>
          Verified makeup artist listings will populate this section once
        ...
        <div style={styles.directoryGrid}>
          <div style={styles.directoryCard}>
            ...
            <div style={styles.cardBody}>
              <h3 style={styles.directoryTitle}>Artist Listing</h3>
      ...
      <section style={styles.ctaSection}>
        ...
        <p style={styles.sectionText}>
          Makeup artists may submit for review. Hand-selected professionals may
