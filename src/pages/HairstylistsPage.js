    ...
    <main style={styles.page}>
      <section style={styles.hero}>
        ...
        <div style={styles.heroContent}>
          ...
          <h1 style={styles.title}>Hairstylists</h1>

          <p style={styles.subtitle}>
            Explore verified hairstylists specializing in beauty, editorial,
            production, and image-focused work.
          </p>
        </div>
      </section>
      ...
      <section style={styles.section}>
        ...
        <div style={styles.filters}>
          ...
          <select style={styles.select} defaultValue="">
            ...
            <option value="Editorial Hair">Editorial Hair</option>
            <option value="Film & Television">Film & Television</option>
            <option value="Celebrity Styling">Celebrity Styling</option>
            ...
            <option value="Runway Hair">Runway Hair</option>
          </select>
        </div>
      </section>
      ...
      <section style={styles.section}>
        ...
        <h2 style={styles.sectionTitle}>Featured Hairstylists</h2>

        <p style={styles.sectionText}>
          Hand-selected hairstylists will appear here as the Collective grows.
        </p>
        ...
        <div style={styles.featuredGrid}>
          <div style={styles.featuredCard}>
            ...
            <div style={styles.cardBody}>
              <p style={styles.cardLabel}>Featured Hairstylist</p>
      ...
      <section style={styles.section}>
        ...
        <h2 style={styles.sectionTitle}>All Hairstylists</h2>

        <p style={styles.sectionText}>
          Verified hairstylist listings will populate this section once approved
          profiles are added.
        </p>
        ...
        <div style={styles.directoryGrid}>
          <div style={styles.directoryCard}>
            ...
            <div style={styles.cardBody}>
              <h3 style={styles.directoryTitle}>Stylist Listing</h3>
      ...
      <section style={styles.ctaSection}>
        ...
        <p style={styles.sectionText}>
          Hairstylists may submit for review. Hand-selected professionals may
