...
export default function BeautyCompaniesPage() {
  return (
    <main style={styles.page}>
      <section style={styles.hero}>
        ...
        <div style={styles.heroContent}>
          ...
          <h1 style={styles.title}>Beauty Companies & Teams</h1>

          <p style={styles.subtitle}>
            Discover verified beauty companies, agencies, studios, and
            production teams supporting entertainment, media, commercial, and
            creative productions around the world.
          </p>
        </div>
      </section>
      ...
      <section style={styles.section}>
        ...
        <h2 style={styles.sectionTitle}>Find the right company or team.</h2>
        ...
        <div style={styles.filters}>
          ...
          <select style={styles.select} defaultValue="">
            ...
            <option value="Beauty Agency">Beauty Agency</option>
            <option value="Production Beauty Team">Production Beauty Team</option>
            <option value="Hair Team">Hair Team</option>
            <option value="SFX Team">SFX Team</option>
      ...
      <section style={styles.section}>
        ...
        <p style={styles.sectionText}>
          Hand-selected beauty companies and teams will appear here as the
          Collective grows.
        </p>
        ...
        <div style={styles.featuredGrid}>
          <div style={styles.featuredCard}>
            ...
            <div style={styles.cardBody}>
              <p style={styles.cardLabel}>Featured Company</p>
          ...
          <div style={styles.featuredCard}>
            <div style={styles.featuredImage} />
            <div style={styles.cardBody}>
              <p style={styles.cardLabel}>Featured Team</p>
              <h3 style={styles.cardTitle}>Coming Soon</h3>
              <p style={styles.cardMeta}>Global</p>
            </div>
          </div>
      ...
      <section style={styles.section}>
        ...
        <h2 style={styles.sectionTitle}>All Companies & Teams</h2>

        <p style={styles.sectionText}>
          Verified beauty company and team listings will populate this section
          once approved profiles are added.
        </p>
        ...
        <div style={styles.directoryGrid}>
          <div style={styles.directoryCard}>
            ...
            <div style={styles.cardBody}>
              <h3 style={styles.directoryTitle}>Company Listing</h3>
          ...
          <div style={styles.directoryCard}>
            <div style={styles.directoryImage} />
            <div style={styles.cardBody}>
              <h3 style={styles.directoryTitle}>Team Listing</h3>
              <p style={styles.cardMeta}>City, Region, Country</p>
            </div>
          </div>
      ...
      <section style={styles.ctaSection}>
        ...
        <p style={styles.sectionText}>
          Beauty companies and teams may submit for review. Hand-selected
          companies may also be added directly by Aset.
        </p>
