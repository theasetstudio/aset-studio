...
export default function GroomingArtistsPage() {
  return (
    <main style={styles.page}>
      <section style={styles.hero}>
        ...
        <div style={styles.heroContent}>
          ...
          <h1 style={styles.title}>Grooming Artists</h1>

          <p style={styles.subtitle}>
            Explore grooming professionals supporting talent presentation, media
            appearances, and production-ready looks.
          </p>
        </div>
      </section>
      ...
      <section style={styles.section}>
        ...
        <div style={styles.filters}>
          ...
          <select style={styles.select} defaultValue="">
            ...
            <option value="Talent Grooming">Talent Grooming</option>
            <option value="Editorial Grooming">Editorial Grooming</option>
      ...
      <section style={styles.section}>
        ...
        <h2 style={styles.sectionTitle}>Featured Grooming Artists</h2>

        <p style={styles.sectionText}>
          Hand-selected grooming artists will appear here as the Collective grows.
        </p>
        ...
        <div style={styles.featuredGrid}>
          <div style={styles.featuredCard}>
            ...
            <div style={styles.cardBody}>
              <p style={styles.cardLabel}>Featured Grooming Artist</p>
      ...
      <section style={styles.section}>
        ...
        <h2 style={styles.sectionTitle}>All Grooming Artists</h2>

        <p style={styles.sectionText}>
          Verified grooming artist listings will populate this section once
        ...
        <div style={styles.directoryGrid}>
          <div style={styles.directoryCard}>
            ...
            <div style={styles.cardBody}>
              <h3 style={styles.directoryTitle}>Grooming Artist Listing</h3>
      ...
      <section style={styles.ctaSection}>
        ...
        <p style={styles.sectionText}>
          Grooming artists may submit for review. Hand-selected professionals may
